  ...
  <div>
      ...
      <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
        <div className="w-24  rounded-full">
          <img className='' src= {users?.photoURL||"https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" }/>   
      ...
      <ul tabIndex={0} className=" ">
        ...
        <li><button className="btn  btn-ghost"> {users?.displayName|| 'name not found'}</button></li>
